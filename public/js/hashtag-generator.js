...
async function summarizeText(text) {
  const prompt = `genera hashtags relevantes para el siguiente texto, sin agregar explicaciones ni saludos, ni despedidas, ni opiniones.
...
document.getElementById('generate-btn').addEventListener('click', async () => {
  ...
  try {
    ...
    resultEl.textContent = `Detected language: ${detectedLanguage}. Generating...`;
