...
async function summarizeText(text) {
  const prompt = `corrige los errores gramaticales y faltas de ortografias del siguiente texto. sin agregar explicaciones ni saludos, ni despedidas, ni opiniones.
