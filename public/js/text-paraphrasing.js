...
async function summarizeText(text) {
  const prompt = `parafrasea el siguiente texto de forma natural, cambia palabras por sus sinonimos.  sin agregar explicaciones ni saludos, ni despedidas, ni opiniones.
...
document.getElementById('generate-btn').addEventListener('click', async () => {
  ...
  try {
    ...
    resultEl.textContent = `Detected language: ${detectedLanguage}. Paraphrasing...`;
